...
import { ERC20GrandmaToken, ERC20GrandmaToken__factory } from "../typechain-types";
import { Signer } from "ethers";


describe("ERC20GrandmaToken", function () {

  let totalSupply = '10000000000000000000000000000';
  let factory: ERC20GrandmaToken__factory;
  let gmaToken: ERC20GrandmaToken;
  let owner: Signer;
  let addr1: Signer;
  let addr2: Signer;
  let addrs: Signer[];
  ...
  beforeEach(async function () {
    ...
    factory = await ethers.getContractFactory("ERC20GrandmaToken");
